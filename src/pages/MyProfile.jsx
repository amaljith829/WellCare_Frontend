...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    phone: "+91 906 172 7180",
    address: {
      line1: "57th Cross,Richmond",
      line2: "Cricle, Church Road,Landon"
    },
    gender: "Male",
    dob: "2000-01-20"
  })
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='mt-10'>
        {
          isEdit
            ? <button className='border border-b-blue-500 px-8 py-2 rounded-full hover:bg-blue-500 hover:text-white transition-all' onClick={() => setIsEdit(false)}>Save</button>
            : <button  className='border border-b-blue-500 px-8 py-2 rounded-full  hover:bg-blue-500 hover:text-white transition-all' onClick={() => setIsEdit(true)}>Edit</button>
        }
      </div>
    </div>
  )
